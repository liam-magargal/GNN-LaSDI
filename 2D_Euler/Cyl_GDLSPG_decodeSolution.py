...
x_hat_hist_in = np.load('Cyl_solutions/Cyl_GD_LSPG_'+str(N_lat)+'_testSol_'+str(testSol)+'.npy')
...
for t in range(Nt):
    ...
    if t==250:
        np.save('Cyl_solutions/GDLSPG_'+str(N_lat)+'_testSol_'+str(testSol)+'_ducros250',ducros_approx)
        np.save('Cyl_solutions/GT_testSol_'+str(testSol)+'_ducros250',ducros_GT)
        np.save('Cyl_solutions/GDLSPG_'+str(N_lat)+'_testSol_'+str(testSol)+'_sol250',x_hist_approx[:,t])
        np.save('Cyl_solutions/GT_testSol_'+str(testSol)+'_sol250',x_hist_in[:,t])
    if t==500:
        np.save('Cyl_solutions/GDLSPG_'+str(N_lat)+'_testSol_'+str(testSol)+'_ducros500',ducros_approx)
        np.save('Cyl_solutions/GT_testSol_'+str(testSol)+'_ducros500',ducros_GT)
        np.save('Cyl_solutions/GDLSPG_'+str(N_lat)+'_testSol_'+str(testSol)+'_sol500',x_hist_approx[:,t])
...
np.save('Cyl_solutions/GDLSPG_pc_error_'+str(N_lat)+'_testSol_'+str(testSol),interfaceError)
