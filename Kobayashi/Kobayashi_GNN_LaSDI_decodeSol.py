...
x_hat_hist_in = np.load('Kobayashi_solutions/Kobayashi_GNN_LaSDI_'+str(N_lat)+'_testSol_'+str(testSol)+'.npy')
...
for t in range(Nt):
    ...
    if t==250:
        np.save('Kobayashi_solutions/GNN_LaSDI_'+str(N_lat)+'_testSol_'+str(testSol)+'_canny250',cannyFilter_approx.reshape((Nx,Nx)))
        np.save('Kobayashi_solutions/GT_testSol_'+str(testSol)+'_canny250',cannyFilter_GT.reshape((Nx,Nx)))
        np.save('Kobayashi_solutions/GNN_LaSDI_'+str(N_lat)+'_testSol_'+str(testSol)+'_sol250',x_hist_approx[:N,t].reshape((Nx,Nx)))
        np.save('Kobayashi_solutions/GT_testSol_'+str(testSol)+'_sol250',x_hist_in[testSol,:N,t].reshape((Nx,Nx)))
    if t==500:
        np.save('Kobayashi_solutions/GNN_LaSDI_'+str(N_lat)+'_testSol_'+str(testSol)+'_canny500',cannyFilter_approx.reshape((Nx,Nx)))
        np.save('Kobayashi_solutions/GT_testSol_'+str(testSol)+'_canny500',cannyFilter_GT.reshape((Nx,Nx)))
        np.save('Kobayashi_solutions/GNN_LaSDI_'+str(N_lat)+'_testSol_'+str(testSol)+'_sol500',x_hist_approx[:N,t].reshape((Nx,Nx)))
...
np.save('Kobayashi_solutions/GNN_LaSDI_pc_error_'+str(N_lat)+'_testSol_'+str(testSol),interfaceError)
np.save('Kobayashi_solutions/GNN_LaSDI_pc_2norm_error_'+str(N_lat)+'_testSol_'+str(testSol),interfaceError_2norm)
